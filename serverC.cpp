...
int main(void)
{
    ...
    while(1){
        ...
        cout << "The Server C has received " << count << " numbers."<<endl;
        
        cout << "The Server C has successfully finished the reduction " << type <<":";
        
        //prepare to send the results to AWS
        stringstream backend_total;
        backend_total<<"C"; //pack the server name into the string stream with the answer
